...
function deleteTask() {
	...
	if( task_id_selected !== null ) {
		...
		const otherTask = taskElement.nextElementSibling;
		
		selectTask(otherTask);
		taskElement.remove();
...
function selectTask(taskElement) {
	...
	//	
	//	
	////	// Put transparent border around previously selected sk
	////	if( task_id_selected !== null {
	////		const prevElement = document.getElementById(task_id_select);
	////		prevElement.setAttribute("data-select-status",");
	////		prevElement.querySelector("div").style.borderColor = myTranspare;	
	//	}
	//	
	//	
	////	// Select new task and put black border arounit
	////	task_id_selected = taskElementd;
	////	taskElement.setAttribute("data-select-status",");
	//	taskElement.querySelector("div").style.borderColor = myBlac
}
