...
public class Controller extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		// If username is not found in session object, it means user is not logged in, so forward to login page
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		// In case action equals "login", it means the user has sent a login attempt, so let's process that
		if( action.equals("login") )
		{
			...
			if( (username.equals("peter") && password.equals("9805")) || (username.equals("jens") && password.equals("1234")) )
			{
